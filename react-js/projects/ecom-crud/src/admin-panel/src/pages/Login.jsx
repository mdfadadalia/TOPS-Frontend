...
export default function Login() {
  ...
  const submit = async () => {
    ...
    if (loginUser.fulfilled.match(result) && result.payload?.role === "admin") navigate(location.state?.from?.pathname || "/admin", { replace: true });
  };
    ...
    <div className="auth-wrap">
      ...
      <div className="auth-form-col">
        <div className="auth-card">
          ...
          <p className="hint">
            Static design preview — no backend authentication is connected.
          </p>
          ...
          >
            Demo mode: clicking Sign in opens the static admin dashboard.
          </p>
        </div>
      </div>
    </div>
